...
export class ChamadoUpdateComponent implements OnInit {
  ...
  constructor(
    ...
    private chamdadoService: ChamadoService,
  ...
  findById(): void {
    this.chamdadoService.findById(this.chamado.id).subscribe(resposta => {
  ...
  update(): void {
    this.chamdadoService.update(this.chamado).subscribe(() => {
